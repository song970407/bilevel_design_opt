...
def generate_heater_location(bilevel_design_opt_config):
    num_x_list = bilevel_design_opt_config['num_x_list']
    num_heaters_list = bilevel_design_opt_config['num_heaters_list']
    num_graphs = bilevel_design_opt_config['num_repeats']
    domain_range = bilevel_design_opt_config['domain_range']
    epsilon = bilevel_design_opt_config['epsilon']
    num_targets = bilevel_design_opt_config['num_targets']
    target_length = bilevel_design_opt_config['target_length']
    max_heatups = bilevel_design_opt_config['max_heatups']
    target_range = bilevel_design_opt_config['target_range']
    initial_target = bilevel_design_opt_config['initial_target']
    saved_dir = bilevel_design_opt_config['saved_dir']
    seed_num = bilevel_design_opt_config['seed_num']
    fix_seed(seed_num)
...
if __name__ == '__main__':
    ...
    bilevel_design_opt_config = yaml.safe_load(open('config/data/bilevel_design_opt_config.yaml', 'r'))
    generate_heat_diffusion_data(env_config, data_generation_config)
    generate_heater_location(bilevel_design_opt_config)
